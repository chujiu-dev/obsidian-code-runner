...
后续还将更新语言切换、交互式输入、自动输入识别等功能，也许还会和其他插件组合使用，实现更多功能。
...
In the future, language switching, interactive input, and automatic input detection features will be updated. Maybe it will also be used in combination with other plugins to achieve more functions.
