...
const icons = {
  ...
  play: () => <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" width="0.6em" height="0.7em" viewBox="0 0 384 512">
  ...
  stop: () => <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" width="0.7em" height="0.7em" viewBox="0 0 24 24">
